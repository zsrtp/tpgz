...
KEEP_FUNC PauseMenu::PauseMenu(PauseData& data)
    : Menu(),
      cursor(data.cursor),
      l_ordonSword_idx(data.l_ordonSword_idx),
      l_masterSword_idx(data.l_masterSword_idx),
      l_woodShield_idx(data.l_woodShield_idx),
      l_hyShield_idx(data.l_hyShield_idx),
      l_tunic_idx(data.l_tunic_idx),
      l_zoraArmor_idx(data.l_zoraArmor_idx),
      l_magicArmor_idx(data.l_magicArmor_idx),
      l_bombCap_idx(data.l_bombCap_idx),
      l_wallet_idx(data.l_wallet_idx),
      l_arrowCap_idx(data.l_arrowCap_idx),
      l_ebFlag(data.l_ebFlag),
      l_sbFlag(data.l_sbFlag),
      l_bsFlag(data.l_bsFlag),
      l_hsFlag(data.l_hsFlag),
      l_mdFlag(data.l_mdFlag),
      l_jsFlag(data.l_jsFlag),
      l_gsFlag(data.l_gsFlag),
