...
if(PLATFORM STREQUAL "GCN")
    ...
    set(DEVKITPRO_MACHDEP -mno-sdata -DGEKKO -mogc -mcpu=750 -meabi -mhard-float)
else()
message(STATUS "DevkitPro loaded for Wii")
    set(devkitpro_platform_path "wii")
    set(devkitpro_ogclib_path "wii")
    set(DEVKITPRO_MACHDEP -mno-sdata -DGEKKO -mrvl -mcpu=750 -meabi -mhard-float)
endif()
list(JOIN "${DEVKITPRO_MACHDEP}" " " DEVKITPRO_MACHDEP)
