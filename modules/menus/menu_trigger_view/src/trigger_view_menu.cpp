...
KEEP_FUNC TriggerViewMenu::TriggerViewMenu(Cursor& cursor)
    : Menu(cursor), lines{
                        {"view load zones", VIEW_LOAD_ZONES, "", true,
                         ...
                         {"view lja projection", VIEW_LJA_PROJECTION, "", true,
                         &g_triggerViewFlags[VIEW_LJA_PROJECTION].active},
                         {"view midna charge projection", VIEW_MIDNA_CHARGE_PROJECTION, "", true,
                         &g_triggerViewFlags[VIEW_MIDNA_CHARGE_PROJECTION].active},
